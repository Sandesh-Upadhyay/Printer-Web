      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-2xl font-bold text-white mb-4">TechFix Pro</h3>
              <p className="text-gray-300 leading-relaxed">
                Your trusted local printer repair specialists. Fast, reliable, and affordable 
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-300">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span>service@techfixpro.com</span>
              </div>
              <div className="flex items-start space-x-3">
                <MapPin className="w-5 h-5 text-orange-400 mt-1" />
                <span>Serving Metro Area<br />& Surrounding Cities</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-center md:text-left">
              © 2024 TechFix Pro. All rights reserved. Professional printer repair services.
            </p>
